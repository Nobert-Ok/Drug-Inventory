...
#here we check what the user can do with his antimalarial class

drug= Antimalarial('Antimalarial','QUININE','12-09-2022','1-09-2022','4-09-2022',25,'$45','pill','16')
drug.__str__()
...
class TestStringMethod(unittest.TestCase):
    ...
    def testadd(self):
        ...
        drug1 = Antimalarial('Antimalarial', 'CHLOROQUINE', '23-09-2022', '1-09-2022', '4-09-2022', 45, '$60', 'pill',
                             '18')
    ...
    def testprices(self):
        drug1 = Antimalarial('Antimalarial', 'CHLOROQUINE', '23-09-2022', '1-09-2022', '4-09-2022', 45, '$60', 'pill', '18')
